...
___
### The last homework :
[![Homework](https://icons.iconarchive.com/icons/papirus-team/papirus-places/256/folder-yellow-java-icon.png "Go to directory")](src/HW7)

### Answer to any questions about bugs in the code:
![memeGif](https://thumbs.gfycat.com/HighMaleGallowaycow-max-1mb.gif)